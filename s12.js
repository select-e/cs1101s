...
function scan_out_declarations(component) {
    return append(scan_out_function_declarations(component),
                    scan_out_non_function_declarations(component));
}
...
function scan_out_function_declarations(component) {
    return is_sequence(component)
           ? accumulate(append,
                        null,
                        map(scan_out_function_declarations,
...
function scan_out_non_function_declarations(component) {
    return is_sequence(component)
           ? accumulate(append,
                        null,
                        map(scan_out_non_function_declarations,
                            sequence_statements(component)))
           : !is_function_declaration(component) 
